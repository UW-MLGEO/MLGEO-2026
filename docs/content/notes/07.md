...
2. The fact that filtering inevitably modifies the raw dataset. As such, it is important to either *fitler* in code or store filtered data separately from raw data.
